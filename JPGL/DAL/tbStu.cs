...
namespace JPGL.DAL
{
	...
	public partial class tbStu
	{
		...
		public bool Add(JPGL.Model.tbStu model)
		{
			...
			strSql.Append("StuNo,StuName,MajorNo,StuGrade,StuTel,StuCredit)");
            ...
            parameters[2].Value = model.tbMajor;
		...
		public bool Update(JPGL.Model.tbStu model)
		{
            ...
            parameters[1].Value = model.tbMajor;
		...
		public JPGL.Model.tbStu GetModel(string StuNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 StuNo,StuName,MajorNo,StuGrade,StuTel,StuCredit from tbStu ");
			strSql.Append(" where StuNo=@StuNo ");
			SqlParameter[] parameters = {
					new SqlParameter("@StuNo", SqlDbType.VarChar,50)			};
			parameters[0].Value = StuNo;
		...
		public JPGL.Model.tbStu DataRowToModel(DataRow row)
		{
			...
			if (row != null)
			{
				...
				{
                    JPGL.DAL.tbMajor major = new tbMajor();
                    int id = int.Parse(row["MajorNo"].ToString());
                    model.tbMajor = major.GetModel(id);
                    //model.MajorName= major.GetModel(id);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select StuNo,StuName,MajorNo,StuGrade,StuTel,StuCredit ");
